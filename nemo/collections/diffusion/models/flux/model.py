...
class Flux(VisionModule):
    ...
    def forward(
        ...
        """
        if self.config.enable_cuda_graph and self.config.cuda_graph_scope != "full_iteration" and \
                self.config.share_cudagraph_io_buffers and \
                (controlnet_double_block_samples or controlnet_single_block_samples):
